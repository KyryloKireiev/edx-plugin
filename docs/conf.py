...
"""
edx-plugin documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'edx-plugin',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/edx-plugin",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_plugin'),
                os.path.join(root_path, 'edx_plugin/migrations')])
